...
fullmatch = compile('[a-zA-Z0-9\u4e00-\u9fa5]*[a-zA-Z\u4e00-\u9fa5][a-zA-Z0-9\u4e00-\u9fa5]*').fullmatch
...
def frequency(texts, fname='frequency.xlsx'):
    """词频统计"""
    c = Counter(w for t in texts for s in ngram(t) for w in tk0.cut(s) if fullmatch(w)).most_common()
